...
import com.doni.Panels.PurchaserPanel;
...
public class AdminFrame extends JFrame {
	...
	public AdminFrame(LoginFrame af1,Inventory_Database ind1, Purchaser_Database pnd1, Purchase_Database pd1) {
		...
		btnDeleteItems.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e){
				...
				btnDeleteItemsactionPerformed(e);
			}
		...
		try{
			if(textField.getText().trim().equals("") || textField_1.getText().trim().equals("") || textField_2.getText().trim().equals("") || textField_3.getText().trim().equals("") ||textField_4.getText().trim().equals("")) {
				...
				if(textField_1.getText().trim().equals("-1") || textField_2.getText().trim().equals("-1") || textField_3.getText().trim().equals("-1") ||textField_4.getText().trim().equals("-1")) {
					...
					itemWP = Double.valueOf(textField_2.getText().trim());
					itemKey = Integer.valueOf(textField_1.getText().trim());
					itemRP = Double.valueOf(textField_3.getText().trim());
					itemQ = Integer.valueOf(textField_4.getText().trim());
	...
	public void btnDeleteOKActionPerformed(ActionEvent e) {
		...
		try {
			...
			if(textField11.getText().trim().equals("") || textField_11.getText().trim().equals("")) {
				...
				Key itemID = new Key(Integer.valueOf(textField11.getText().trim()));;
				...
				if(ind.delete(itemID,i) == false) {
					...
					for(int j = 0; j < ((DefaultTableModel)table1.getModel()).getRowCount();j++) {

						if(((DefaultTableModel)table1.getModel()).getValueAt(j,1).equals(Integer.valueOf(textField11.getText().trim()))){

							table1.getModel().setValueAt(quantity, j, 4);
	...
	public void btnAddItemsactionPerformed(ActionEvent e) {
		...
		lblQuantity.setBounds(516, 39, 100, 20);
	...
	public void btnDeleteItemsactionPerformed(ActionEvent e) {
